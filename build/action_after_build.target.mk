...
$(srcdir)/test.node: TOOLSET := $(TOOLSET)
$(srcdir)/test.node: $(srcdir)/build/test.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(srcdir)/test.node
binding_gyp_action_after_build_target_copies = $(srcdir)/test.node
...
$(binding_gyp_action_after_build_target_copies): | $(builddir)/test.node

$(obj).target/action_after_build.stamp: TOOLSET := $(TOOLSET)
$(obj).target/action_after_build.stamp: $(builddir)/test.node FORCE_DO_CMD
	$(call do_cmd,touch)
